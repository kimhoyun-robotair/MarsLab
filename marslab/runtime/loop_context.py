...
def build_loop_context(
    *,
    ...
    return LoopContext(
        ...
        negate_steer=bool(control_cfg["negate_steer"]),
        debug_logging=bool(control_cfg["debug_logging"]),
        max_wheel_accel_rate=float(control_cfg["max_wheel_accel_rate"]),
        decel_multiplier=float(control_cfg["decel_multiplier"]),
        max_steer_angle=float(control_cfg["max_steer_angle"]),
        steer_ramp_rate=float(control_cfg["steer_ramp_rate"]),

"""Compute static sun angles and linear sweeps used by the runtime."""

import math
from dataclasses import dataclass
from typing import Literal

# Spherical mode is not connected to config/runtime; keep its code as comments.
...
class SunPosition:
    ...
    Attributes:
        ...
        elevation_deg: Elevation angle in degrees above the horizon.
            Supported range is [0, 90] for the active static and linear paths.
...
def compute_sol_sun_position(
    ...
    *,
    ...
    """Compute a linear sweep; the unused spherical path is commented out."""
    ...
    #     )
    raise ValueError(f"only 'linear' mode is enabled, got {mode!r}")
